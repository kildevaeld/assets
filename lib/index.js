...
var Assets = function (_events_1$EventEmitte) {
    ...
    function Assets(options) {
        ...
        if (isString(options.dataStore)) {
            file = repository_1.getFileStore(options.dataStore, options.dataStoreOptions);
        } else {
            file = options.dataStore;
        }
        if (!meta || !file) {
    ...
    _createClass(Assets, [{
        ...
        value: function thumbnail(asset) {
            return __awaiter(this, void 0, Promise, function* () {
                var stream = yield this.thumbnailer.request(asset);
                return stream;
            });
        }
    }, {
        ...
        value: function getByPath(path) {
            return __awaiter(this, void 0, Promise, function* () {
                var infos = yield this.metaStore.find({
                    path: path
                });
                var info = void 0;
        ...
        value: function query(term) {
            return __awaiter(this, void 0, Promise, function* () {
                return (yield this.metaStore.find({
                    path: term
                })).map(function (a) {
